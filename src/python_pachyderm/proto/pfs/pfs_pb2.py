...
_API = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='InspectFileV2',
    full_name='pfs.API.InspectFileV2',
    index=35,
    containing_service=None,
    input_type=_INSPECTFILEREQUEST,
    output_type=_FILEINFOV2,
