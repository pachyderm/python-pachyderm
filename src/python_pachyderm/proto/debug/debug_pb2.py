...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_protobuf_dot_duration__pb2.DESCRIPTOR,pps_dot_pps__pb2.DESCRIPTOR,])
...
_FILTER.fields_by_name['pipeline'].message_type = pps_dot_pps__pb2._PIPELINE
