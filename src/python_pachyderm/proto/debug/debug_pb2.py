...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_protobuf_dot_duration__pb2.DESCRIPTOR,src_dot_pps_dot_pps__pb2.DESCRIPTOR,])
...
_FILTER.fields_by_name['pipeline'].message_type = src_dot_pps_dot_pps__pb2._PIPELINE
...
ProfileRequest = _reflection.GeneratedProtocolMessageType('ProfileRequest', (_message.Message,), {
  ...
  '__module__' : 'src.debug.debug_pb2'
