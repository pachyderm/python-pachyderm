...
_TRANSACTIONREQUEST.fields_by_name['create_repo'].message_type = pfs_dot_pfs__pb2._CREATEREPOREQUEST
_TRANSACTIONREQUEST.fields_by_name['delete_repo'].message_type = pfs_dot_pfs__pb2._DELETEREPOREQUEST
_TRANSACTIONREQUEST.fields_by_name['start_commit'].message_type = pfs_dot_pfs__pb2._STARTCOMMITREQUEST
_TRANSACTIONREQUEST.fields_by_name['finish_commit'].message_type = pfs_dot_pfs__pb2._FINISHCOMMITREQUEST
_TRANSACTIONREQUEST.fields_by_name['squash_commit'].message_type = pfs_dot_pfs__pb2._SQUASHCOMMITREQUEST
_TRANSACTIONREQUEST.fields_by_name['create_branch'].message_type = pfs_dot_pfs__pb2._CREATEBRANCHREQUEST
_TRANSACTIONREQUEST.fields_by_name['delete_branch'].message_type = pfs_dot_pfs__pb2._DELETEBRANCHREQUEST
_TRANSACTIONREQUEST.fields_by_name['update_job_state'].message_type = pps_dot_pps__pb2._UPDATEJOBSTATEREQUEST
_TRANSACTIONREQUEST.fields_by_name['create_pipeline'].message_type = pps_dot_pps__pb2._CREATEPIPELINEREQUEST
_TRANSACTIONREQUEST.fields_by_name['delete_all'].message_type = _DELETEALLREQUEST
_TRANSACTIONRESPONSE.fields_by_name['commit'].message_type = pfs_dot_pfs__pb2._COMMIT
