...
# source: src/transaction/transaction.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='src/transaction/transaction.proto',
  package='transaction',
  syntax='proto3',
  ...
  ,
  dependencies=[google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,src_dot_pfs_dot_pfs__pb2.DESCRIPTOR,src_dot_pps_dot_pps__pb2.DESCRIPTOR,])
...
_TRANSACTIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='delete_all', full_name='transaction.TransactionRequest.delete_all', index=9,
...
_TRANSACTIONREQUEST.fields_by_name['create_repo'].message_type = src_dot_pfs_dot_pfs__pb2._CREATEREPOREQUEST
_TRANSACTIONREQUEST.fields_by_name['delete_repo'].message_type = src_dot_pfs_dot_pfs__pb2._DELETEREPOREQUEST
_TRANSACTIONREQUEST.fields_by_name['start_commit'].message_type = src_dot_pfs_dot_pfs__pb2._STARTCOMMITREQUEST
_TRANSACTIONREQUEST.fields_by_name['finish_commit'].message_type = src_dot_pfs_dot_pfs__pb2._FINISHCOMMITREQUEST
_TRANSACTIONREQUEST.fields_by_name['squash_commit'].message_type = src_dot_pfs_dot_pfs__pb2._SQUASHCOMMITREQUEST
_TRANSACTIONREQUEST.fields_by_name['create_branch'].message_type = src_dot_pfs_dot_pfs__pb2._CREATEBRANCHREQUEST
_TRANSACTIONREQUEST.fields_by_name['delete_branch'].message_type = src_dot_pfs_dot_pfs__pb2._DELETEBRANCHREQUEST
_TRANSACTIONREQUEST.fields_by_name['update_job_state'].message_type = src_dot_pps_dot_pps__pb2._UPDATEJOBSTATEREQUEST
_TRANSACTIONREQUEST.fields_by_name['create_pipeline'].message_type = src_dot_pps_dot_pps__pb2._CREATEPIPELINEREQUEST
_TRANSACTIONREQUEST.fields_by_name['delete_all'].message_type = _DELETEALLREQUEST
_TRANSACTIONRESPONSE.fields_by_name['commit'].message_type = src_dot_pfs_dot_pfs__pb2._COMMIT
...
DeleteAllRequest = _reflection.GeneratedProtocolMessageType('DeleteAllRequest', (_message.Message,), {
  ...
  '__module__' : 'src.transaction.transaction_pb2'
