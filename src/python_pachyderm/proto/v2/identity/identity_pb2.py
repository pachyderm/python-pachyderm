...
_IDENTITYSERVERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rotation_token_expiry', full_name='identity_v2.IdentityServerConfig.rotation_token_expiry', index=2,
...
_IDPCONNECTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='config', full_name='identity_v2.IDPConnector.config', index=5,
...
_IDPCONNECTOR.fields_by_name['config'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
...
_IDPCONNECTOR.fields_by_name['jsonConfig']._options = None
_IDPCONNECTOR.fields_by_name['config']._options = None
_OIDCCLIENT.fields_by_name['secret']._options = None
