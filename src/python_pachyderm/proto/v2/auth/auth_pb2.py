...
_ROLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='can_be_bound_to', full_name='auth_v2.Role.can_be_bound_to', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='returned_for', full_name='auth_v2.Role.returned_for', index=3,
...
_ROLE.fields_by_name['can_be_bound_to'].enum_type = _RESOURCETYPE
_ROLE.fields_by_name['returned_for'].enum_type = _RESOURCETYPE
