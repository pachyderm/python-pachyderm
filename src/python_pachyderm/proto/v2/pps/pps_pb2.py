...
_API = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=26,
    containing_service=None,
    input_type=python__pachyderm_dot_proto_dot_v2_dot_pfs_dot_pfs__pb2._RUNLOADTESTREQUEST,
