...
_PAUSESTATUSRESPONSE_PAUSESTATUS = _descriptor.EnumDescriptor(
  name='PauseStatus',
  full_name='enterprise_v2.PauseStatusResponse.PauseStatus',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='UNPAUSED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PARTIALLY_PAUSED', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_PAUSEREQUEST = _descriptor.Descriptor(
  name='PauseRequest',
  full_name='enterprise_v2.PauseRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_PAUSERESPONSE = _descriptor.Descriptor(
  name='PauseResponse',
  full_name='enterprise_v2.PauseResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_UNPAUSEREQUEST = _descriptor.Descriptor(
  name='UnpauseRequest',
  full_name='enterprise_v2.UnpauseRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_UNPAUSERESPONSE = _descriptor.Descriptor(
  name='UnpauseResponse',
  full_name='enterprise_v2.UnpauseResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_PAUSESTATUSREQUEST = _descriptor.Descriptor(
  name='PauseStatusRequest',
  full_name='enterprise_v2.PauseStatusRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_PAUSESTATUSRESPONSE = _descriptor.Descriptor(
  name='PauseStatusResponse',
  full_name='enterprise_v2.PauseStatusResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='enterprise_v2.PauseStatusResponse.status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _PAUSESTATUSRESPONSE_PAUSESTATUS,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_PAUSESTATUSRESPONSE.fields_by_name['status'].enum_type = _PAUSESTATUSRESPONSE_PAUSESTATUS
_PAUSESTATUSRESPONSE_PAUSESTATUS.containing_type = _PAUSESTATUSRESPONSE
...
DESCRIPTOR.message_types_by_name['UnpauseRequest'] = _UNPAUSEREQUEST
DESCRIPTOR.message_types_by_name['UnpauseResponse'] = _UNPAUSERESPONSE
DESCRIPTOR.message_types_by_name['PauseStatusRequest'] = _PAUSESTATUSREQUEST
DESCRIPTOR.message_types_by_name['PauseStatusResponse'] = _PAUSESTATUSRESPONSE
...
PauseRequest = _reflection.GeneratedProtocolMessageType('PauseRequest', (_message.Message,), {
  ...
  '__module__' : 'python_pachyderm.proto.v2.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_v2.PauseRequest)
  })
...
PauseResponse = _reflection.GeneratedProtocolMessageType('PauseResponse', (_message.Message,), {
  ...
  '__module__' : 'python_pachyderm.proto.v2.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_v2.PauseResponse)
  })
_sym_db.RegisterMessage(PauseResponse)

UnpauseRequest = _reflection.GeneratedProtocolMessageType('UnpauseRequest', (_message.Message,), {
  'DESCRIPTOR' : _UNPAUSEREQUEST,
  '__module__' : 'python_pachyderm.proto.v2.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_v2.UnpauseRequest)
  })
_sym_db.RegisterMessage(UnpauseRequest)

UnpauseResponse = _reflection.GeneratedProtocolMessageType('UnpauseResponse', (_message.Message,), {
  'DESCRIPTOR' : _UNPAUSERESPONSE,
  '__module__' : 'python_pachyderm.proto.v2.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_v2.UnpauseResponse)
  })
_sym_db.RegisterMessage(UnpauseResponse)

PauseStatusRequest = _reflection.GeneratedProtocolMessageType('PauseStatusRequest', (_message.Message,), {
  'DESCRIPTOR' : _PAUSESTATUSREQUEST,
  '__module__' : 'python_pachyderm.proto.v2.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_v2.PauseStatusRequest)
  })
_sym_db.RegisterMessage(PauseStatusRequest)

PauseStatusResponse = _reflection.GeneratedProtocolMessageType('PauseStatusResponse', (_message.Message,), {
  'DESCRIPTOR' : _PAUSESTATUSRESPONSE,
  '__module__' : 'python_pachyderm.proto.v2.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_v2.PauseStatusResponse)
  })
_sym_db.RegisterMessage(PauseStatusResponse)
...
_API = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Pause',
    full_name='enterprise_v2.API.Pause',
    index=5,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='Unpause',
    full_name='enterprise_v2.API.Unpause',
    index=6,
    containing_service=None,
    input_type=_UNPAUSEREQUEST,
    output_type=_UNPAUSERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='PauseStatus',
    full_name='enterprise_v2.API.PauseStatus',
    index=7,
    containing_service=None,
    input_type=_PAUSESTATUSREQUEST,
    output_type=_PAUSESTATUSRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
