...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[pfs_dot_pfs__pb2.DESCRIPTOR,])
...
_INPUT.fields_by_name['file_info'].message_type = pfs_dot_pfs__pb2._FILEINFO
_INPUT.fields_by_name['parent_commit'].message_type = pfs_dot_pfs__pb2._COMMIT
DESCRIPTOR.message_types_by_name['Input'] = _INPUT
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

Input = _reflection.GeneratedProtocolMessageType('Input', (_message.Message,), {
  'DESCRIPTOR' : _INPUT,
  '__module__' : 'server.worker.common.common_pb2'
