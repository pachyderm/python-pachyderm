...
class DeletePipelinesRequest(betterproto.Message):
    ...
    projects: List["_pfs_v2__.Project"] = betterproto.message_field(1)
...
class ApiStub(betterproto.ServiceStub):
    ...
    async def delete_pipelines(
        ...
        *,
        ...
        return await self._unary_unary(
            "/pps_v2.API/DeletePipelines", request, DeletePipelinesResponse
        )
...
class ApiBase(ServiceBase):
    ...
    async def __rpc_delete_pipelines(self, stream: grpclib.server.Stream) -> None:
        request = await stream.recv_message()
        ...
        response = await self.delete_pipelines(**request_kwargs)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/pps_v2.API/DeletePipelines": grpclib.const.Handler(
                self.__rpc_delete_pipelines,
                grpclib.const.Cardinality.UNARY_UNARY,
