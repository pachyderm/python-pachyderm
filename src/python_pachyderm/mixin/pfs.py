...
class PFSMixin:
    ...
    def start_commit(
        self, repo_name, branch="master", parent=None, description=None, provenance=None
    ):
        """
        ...
        * `provenance`: An optional iterable of `CommitProvenance` objects
        ...
        if parent and isinstance(parent, str):
            parent = commit_from((repo_name, parent))
        return self._req(
            Service.PFS,
            "StartCommit",
            parent=parent,
    ...
    @contextmanager
    def commit(self, repo_name, branch="master", parent=None, description=None):
        """
