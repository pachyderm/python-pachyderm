...
_TRANSACTIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='delete_all', full_name='transaction.TransactionRequest.delete_all', index=7,
...
TransactionInfos = _reflection.GeneratedProtocolMessageType('TransactionInfos', (_message.Message,), dict(
...
InspectTransactionRequest = _reflection.GeneratedProtocolMessageType('InspectTransactionRequest', (_message.Message,), dict(
...
FinishTransactionRequest = _reflection.GeneratedProtocolMessageType('FinishTransactionRequest', (_message.Message,), dict(
