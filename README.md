...
2. Pachyderm core has stabilized enough that, for the most part, even if you're using an older version of this library, it will work with newer versions of a pachyderm cluster.
...
If you need to know which version of pachyderm core that a version of python-pachyderm was built with, consult `CHANGELOG.md`.
