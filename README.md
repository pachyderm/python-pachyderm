...
**WARNING! This package is no longer maintained nor supported. Please transition to the currently maintained Python SDK for Pachyderm: [pachyderm-sdk](https://github.com/pachyderm/pachyderm/tree/master/python-sdk)**
